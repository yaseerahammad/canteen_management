...
const foodItems = [
  // Breakfast
  { id: 'BR1', name: 'Masala Dosa', price: 50, category: 'Breakfast', image: 'https://vismaifood.com/storage/app/uploads/public/8b4/19e/427/thumb__1200_0_0_0_auto.jpg' },
  { id: 'BR2', name: 'Pav Bhaji', price: 60, category: 'Breakfast', image: 'https://static.toiimg.com/photo/52416693.cms' },
  { id: 'BR3', name: 'Samosa', price: 20, category: 'Breakfast', image: 'https://sinfullyspicy.com/wp-content/uploads/2010/09/5.jpg' },
  { id: 'BR4', name: 'Idli with Sambar', price: 40, category: 'Breakfast', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbc-3FoAFlG-sxKm8_MF33MXcmybRE7J11hw&s' },
  { id: 'BR5', name: 'Upma', price: 35, category: 'Breakfast', image: 'https://d1uz88p17r663j.cloudfront.net/original/ba32df908435796279e3d79f0d5fbdc1_Rava_Upma_-_Twist.jpg' },
  { id: 'BR6', name: 'Poori with Aloo', price: 45, category: 'Breakfast', image: 'https://sinfullyspicy.com/wp-content/uploads/2010/09/5.jpg' },
